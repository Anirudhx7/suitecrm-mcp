...
For production, pin to a release tag such as `v5.0.0` instead of floating on `latest`.

```bash
curl -o docker-compose.yml https://raw.githubusercontent.com/anirudhx7/suitecrm-mcp/v5.0.0/docker-compose.yml
```
...
services:
  ...
  suitecrm-mcp-auth:
    image: ghcr.io/anirudhx7/suitecrm-mcp:v5.0.0
